...
curl -f -L -s -S "https://raw.githubusercontent.com/davbebawy/hassio-addons/refs/heads/main/.templates/ha_automatic_packages.sh" --output /ha_automatic_packages.sh
